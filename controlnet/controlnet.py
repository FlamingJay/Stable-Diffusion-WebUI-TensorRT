...
from engines import base_unet_engine, controlnet_engine
...
class Script(scripts.Script):
    ...
    def process(self, p, *args):
        ...
        self.latest_network.hook(model=unet, sd_ldm=sd_ldm, control_params=forward_params, process=p, unet_engine=base_unet_engine, control_engine=controlnet_engine)
