...
class ControlUnet(UNetModel):
    def forward(self, x, timesteps=None, context=None,
                control_0=None, control_1=None, control_2=None, control_3=None,
                control_4=None, control_5=None, control_6=None, control_7=None,
                control_8=None, control_9=None, control_10=None, control_11=None,
                control_12=None, y=None,
                **kwargs):
        control = [
            control_0, control_1, control_2, control_3, control_4, control_5, control_6,
        ...
        for i, module in enumerate(self.output_blocks):
            self.current_h_shape = (h.shape[0], h.shape[1], h.shape[2], h.shape[3])
            h = th.cat([h, aligned_adding(hs.pop(), control.pop(), require_inpaint_hijack)], dim=1)
            h = module(h, emb, context)
